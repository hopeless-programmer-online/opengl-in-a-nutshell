...
layout (location = 0) uniform float coordinates[6];
...
int main() {
    try {
        ...
        const auto window = glfwCreateWindow(800, 600, "Uniform triangle", nullptr, nullptr);
        ...
        glProgramUniform1fv(program, 0, 6, coordinates);
