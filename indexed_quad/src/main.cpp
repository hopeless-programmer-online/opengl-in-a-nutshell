...
int main() {
    try {
        ...
        const auto window = glfwCreateWindow(800, 600, "Indexed quad", nullptr, nullptr);
        ...
        glNamedBufferStorage(vertexBuffer, sizeof(decltype(vertices)::value_type) * vertices.size(), vertices.data(), 0);
